...
//import {app_initializer,auth,facebookAuthProvider} from '../firebase_folder/firebase';
...
export default class Facebook extends Component{
  constructor(props)
  {
    ...
    this.facebookAuthFirebase = this.facebookAuthFirebase.bind(this);
  }
  state={
    isLoggedIn:false,
...
facebookAuthFirebase(){
  // app_initializer.auth().signInWithPopup(facebookAuthProvider).then((user,err) =>{
  //   if(err){
  //     console.log(err);
  //   }
  //   else{
...
responseFacebook = response => {
  ...
  if(localStorage.getItem('userID')!=response.userID){
